            ...
            {showPlatformSelection && (
              <div className="space-y-2">
                <div className="flex items-center">
                  <button
                    className={`flex items-center p-2 rounded-md ${platforms.includes('instagram') ? 'bg-gray-200' : 'bg-white'} focus:outline-none`}
                  ...
                  {platforms.includes('instagram') && (
                    <input
                      type="text"
                      className="w-full border p-2 rounded-md ml-4 focus:outline-none focus:ring-2 focus:ring-purple-500"
                ...
                <div className="flex items-center">
                  <button
                    className={`flex items-center p-2 rounded-md ${platforms.includes('youtube') ? 'bg-gray-200' : 'bg-white'} focus:outline-none`}
                ...
                <div className="flex items-center">
                  <button
                    className={`flex items-center p-2 rounded-md ${platforms.includes('tiktok') ? 'bg-gray-200' : 'bg-white'} focus:outline-none`}

    ...
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="bg-white rounded-lg shadow-lg w-full max-w-lg p-6 mx-4 md:mx-0 md:max-w-2xl z-10 overflow-auto max-h-[90vh]">
        ...
        <div className="mt-4 space-y-4">
          ...
          <div className="space-y-2">
            <label className="block mb-2 text-sm text-gray-600">플랫폼 선택</label>
            <div className="space-y-2">
              <label className="flex items-center">
                ...
                <span className="text-sm">
                    <InstagramIcon className="w-6 h-6 mr-2" /> Instagram
                </span>
              </label>
              ...
              <label className="flex items-center">
                ...
                />
                <span className="text-sm">
                    <YouTubeIcon className="w-6 h-6 mr-2" /> YouTube
                </span>
              </label>
              ...
              <label className="flex items-center">
                ...
                />
                <span className="text-sm">
                    <TikTokIcon className="w-6 h-6 mr-2" /> TikTok
                </span>
              </label>
